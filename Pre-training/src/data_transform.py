...
from transform import Reinhard_Devlin_train, Reinhard_Devlin_test,truncate_train_osu,truncate_train_ben,truncate_test_osu,truncate_test_ben
import math
...
class Reinhard_train(object):
    def __init__(self, para):
        self.para = para
    def __call__(self, img):
        return Reinhard_Devlin_train(img,self.para)
class Reinhard_test(object):
    def __init__(self, para):
        self.para = para
    def __call__(self, img):
        return Reinhard_Devlin_test(img,self.para)
    
class truncated_train_osu(object):
    def __init__(self, para):
        self.para = para
    def __call__(self, img):
        return truncate_train_osu(img,self.para,255,0)
class truncated_test_osu(object):
    def __init__(self, para):
        self.para = para
    def __call__(self, img):
        return truncate_test_osu(img,self.para,255,0)
    
class truncated_train_ben(object):
    def __init__(self, para):
        self.para = para
    def __call__(self, img):
        return truncate_train_ben(img,self.para,255,0)
class truncated_test_ben(object):
    def __init__(self, para):
        self.para = para
    def __call__(self, img):
        return truncate_test_ben(img,self.para,255,0)
