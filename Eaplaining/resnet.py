...
class ResNet(nn.Module):
    ...
    def forward(self, x):
        ...
        feature_layer4 = self.layer4(feature_layer3)
        feature_avgpool = self.avgpool(feature_layer4) 
        feature_flatten = torch.flatten(feature_avgpool, 1)
        feature_fc= self.fc(feature_flatten) #? outputs
        return feature_fc,feature_layer4
